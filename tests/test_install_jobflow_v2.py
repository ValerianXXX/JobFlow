...
class ThinV2InstallerTests(unittest.TestCase):
    ...
    def test_static_contract_is_thin_bootstrap_first(self) -> None:
        ...
        self.assertIn("[Console]::InputEncoding = [Text.UTF8Encoding]::new($false, $true)", self.source)
        self.assertIn("$process.StandardInput.BaseStream.Write($stdinBytes", self.source)
