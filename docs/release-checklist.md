...
- [ ] Create an annotated or signed `v0.3.0` tag only after all evidence is fresh.
...
- `0.3.0` is an Alpha release candidate and does not claim blanket live ATS compatibility.
