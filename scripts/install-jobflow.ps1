...
$versionText = & $pythonCommand.Source @pythonPrefix -c "import sys; print(f'{sys.version_info.major}.{sys.version_info.minor}')"
...
if (-not (Test-Path -LiteralPath $venvPython -PathType Leaf)) {
    & $pythonCommand.Source @pythonPrefix -m venv $venvRoot
