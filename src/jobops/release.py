...
def write_release_reports(project: Path, result: dict[str, Any]) -> None:
    ...
    lines = [
        ...
        *[
        ...
        "## Public CLI", "",
        "`status`, `audit`, `locate`, `init-db`, `migrate-db`, `secure-onboard`, `secure-onboard-resume`, `finalize-resume-onboarding`, `review-onboarding`, `secure-import-master-resume`, `secure-import-answer-bank`, `secure-store-status`, `purge-synthetic-private-data`, `propose-claims`, `list-claim-proposals`, `approve-claim`, `reject-claim`, `revoke-claim`, `revalidate-claims`, `ats-capabilities`, `product-capabilities`, `discover-official-jobs`, `verify-route`, `analyze-ats-form`, `analyze-ats-sequence`, `import-jd`, `analyze-job`, `run-to-awaiting-approval`, `plan-continuous-intake`, `run-queue`, `list-pending`, `show-review-packet`, `revise-application`, `approve-review-packet`, `reject-review-packet`, `resume-blocked`, `retry-safe-step`, `explain`, `verify-release`.", "",
        "## Document QA", "",
