...
_CONTRACTS: tuple[dict[str, Any], ...] = (
    {
        ...
        "evidence_scope": "DIRECT_SITE_MULTI_PAGE_SEQUENCE_BROWSER_AND_SYNTHETIC_RESULT",
        ...
        "evidence_refs": [
            ...
            "tests/test_provider_multi_page_sequences.py",
            ...
            "tests/fixtures/synthetic-company-direct-sequence.json",
            "tests/fixtures/synthetic-company-direct-sequence-route.json",
            "tests/fixtures/synthetic-company-direct-step-1.html",
            "tests/fixtures/synthetic-company-direct-step-2.html",
            "tests/fixtures/synthetic-company-direct-step-3.html",
    ...
    },
    {
        ...
        "saved_snapshot_modes": ["single_html", "provider_json", "ordered_html_sequence"],
        ...
        "evidence_refs": [
            ...
            "tests/fixtures/synthetic-greenhouse-sequence.json",
            "tests/fixtures/synthetic-greenhouse-sequence-route.json",
            "tests/fixtures/synthetic-greenhouse-step-2.html",
            "tests/fixtures/synthetic-greenhouse-step-3.html",
    ...
    },
    {
        ...
        "evidence_refs": [
            ...
            "tests/fixtures/synthetic-lever-sequence.json",
            "tests/fixtures/synthetic-lever-sequence-route.json",
            "tests/fixtures/synthetic-lever-step-1.html",
            "tests/fixtures/synthetic-lever-step-2.html",
            "tests/fixtures/synthetic-lever-step-3.html",
        ],
        "known_limit_codes": ["LIVE_SITE_ACCEPTANCE_REQUIRED"],
    },
    {
    ...
    },
    {
        ...
        "evidence_refs": [
            ...
            "tests/test_ashby_smartrecruiters_vertical.py",
            "tests/test_provider_multi_page_sequences.py",
            "tests/browser_companion_e2e.cjs",
            "tests/fixtures/synthetic-ashby-jobs.json",
            "tests/fixtures/synthetic-ashby-careers.html",
            "tests/fixtures/synthetic-ashby-route.json",
            "tests/fixtures/synthetic-ashby-form.html",
            "tests/fixtures/synthetic-ashby-sequence.json",
            "tests/fixtures/synthetic-ashby-sequence-route.json",
            "tests/fixtures/synthetic-ashby-step-1.html",
            "tests/fixtures/synthetic-ashby-step-2.html",
            "tests/fixtures/synthetic-ashby-step-3.html",
        ],
        "known_limit_codes": ["LIVE_SITE_ACCEPTANCE_REQUIRED"],
    },
    {
        ...
        "evidence_refs": [
            ...
            "tests/fixtures/synthetic-smartrecruiters-careers.html",
            "tests/fixtures/synthetic-smartrecruiters-route.json",
            "tests/fixtures/synthetic-smartrecruiters-form.html",
            "tests/fixtures/synthetic-smartrecruiters-sequence.json",
            "tests/fixtures/synthetic-smartrecruiters-sequence-route.json",
            "tests/fixtures/synthetic-smartrecruiters-step-1.html",
            "tests/fixtures/synthetic-smartrecruiters-step-2.html",
            "tests/fixtures/synthetic-smartrecruiters-step-3.html",
        ],
        "known_limit_codes": ["LIVE_SITE_ACCEPTANCE_REQUIRED"],
    },
)
