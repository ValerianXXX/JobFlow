...
const STRINGS = {
  zh: {
    ...
    atsCapabilityTitle: "官网与 ATS 合成证据", atsCapabilityBody: "这里显示本版本通过的本地快照和浏览器合成测试；不代表已访问或兼容任意实时网站。", atsLiveUnverified: "实时站点认证：无", atsActionsBlocked: "最终 Submit：锁定", atsEvidenceDirect: "公司官网单页快照", atsEvidenceVertical: "完整合成纵向链", atsEvidenceSingle: "保存的单页表单", atsEvidenceSequence: "保存的多步骤序列",
  ...
  en: {
    ...
    atsCapabilityTitle: "Official-site and ATS synthetic evidence", atsCapabilityBody: "This shows the local snapshot and synthetic-browser tests passed by this release; it is not blanket live-site compatibility.", atsLiveUnverified: "Live-site certified: no", atsActionsBlocked: "Final Submit: locked", atsEvidenceDirect: "Company-site single snapshot", atsEvidenceVertical: "Complete synthetic vertical", atsEvidenceSingle: "Saved single-page form", atsEvidenceSequence: "Saved multi-step sequence",
