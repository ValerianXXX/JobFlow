...
const STRINGS = {
  zh: {
    ...
    demoTitle: "合成演示 · 不使用真实资料", demoBody: "这是自动清理的临时体验环境。所有示例均为虚构内容；文件上传和真实 AI 连接已关闭，请勿在这里输入个人信息。",
  ...
  en: {
    ...
    demoTitle: "Synthetic demo · no real data", demoBody: "This is a temporary, auto-cleaned tour using fictional content only. File intake and real AI connections are disabled; do not enter personal information here.",
...
const state = { locale: "zh", data: null, serviceCompatible: false, lastBlockingError: null, reviewPacket: null, reviewDecision: "", reviewDecisionConfirmed: false, answerDraft: {}, claimDraft: {}, claimEditDraft: {}, conflictDraft: {}, selectedClaims: new Set(), activities: [], activityDurations: {} };
