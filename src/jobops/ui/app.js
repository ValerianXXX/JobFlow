...
const STRINGS = {
  zh: {
    ...
    pipelineBody: "统一查看资料准备、审批队列和真实辅助投递。只有你对单个申请明确授权后，JobFlow 才会读取公司表单、预填并附加材料。", safetyGuardOn: "提交与自动重试始终锁定", offlineMode: "本地准备 + 用户在场辅助", assistedMode: "本地准备 + 用户在场辅助", authorizedActionsAudited: "已授权动作均已审计", browserAssistTitle: "真实公司官网辅助投递", browserAssistBody: "JobFlow 在你在场时预填已批准字段并附加已批准材料，随后强制停在最终提交前。", browserAssistIdle: "等待选择申请", browserCompanionStep: "一次安装浏览器伴侣", browserCompanionHelp: "首次使用请双击项目根目录的“Install JobFlow Browser Companion.cmd”，按窗口提示在 Edge 或 Chrome 中加载一次。以后无需重复安装。", browserCompanionNotPaired: "尚未与本次申请配对", browserCompanionPaired: "浏览器伴侣已配对", browserAssistBoundaryTitle: "不可越过的边界", browserAssistBoundary: "JobFlow 不会点击提交、下一步、登录、注册或绕过验证码。最终提交只能由你亲自点击；结果不明确时只会询问你，不会重试。", browserAssistCompanyOnly: "当前最快版本仅支持已批准的公司同域、访客、单页表单。", browserAssistConsent: "我确认对这一个申请启动 30 分钟的真实表单读取、预填和材料附加授权；我会亲自检查并点击最终提交。", startBrowserAssist: "开始自动预填", startBrowserAssistNow: "建立浏览器连接", startingBrowserAssist: "正在建立一次性浏览器连接…", browserAssistConfirmFirst: "请先勾选本次真实辅助授权。", browserAssistPairing: "正在与浏览器伴侣配对…", browserAssistPaired: "配对成功。请打开已批准的申请页，再点击浏览器右上角的 JobFlow J 图标。", browserAssistExtensionMissing: "没有收到浏览器伴侣响应。请先运行安装入口并在浏览器中加载扩展。", openApprovedApplication: "打开已批准的申请页", browserAssistAwaitingSubmit: "预填与材料附加已完成；请检查后亲自点击最终提交。", browserAssistObserving: "已检测到你点击提交，正在读取结果页。", browserAssistConfirmed: "提交成功，结果页回执已记录。", browserAssistUnknown: "结果无法可靠判断：是否提交成功？", browserAssistFailed: "页面明确显示提交未成功；未自动重试，需要重新审阅后再操作。", submittedYes: "是，已提交成功", submittedNo: "否，没有提交成功", resolveUnknownConfirm: "确认你的判断？JobFlow 不会自动重试。", resolvingSubmission: "正在保存你的提交结果判断…", browserAssistResolved: "提交结果已保存。", statusSubmitted: "等待结果", statusSubmissionUnknown: "结果待确认", statusConfirmed: "已确认提交", installCompanion: "安装浏览器伴侣",
    browserAssistNotApproved: "这份申请尚未完成审阅批准，请先批准当前审阅包。", browserAssistRouteUnsupported: "当前版本只处理公司同域、访客、单页申请表；ATS 跳转或登录流程请等待后续适配。", browserAssistActive: "已有一份申请正在辅助处理中，请先完成或点击紧急停止。", browserAssistWrongPage: "当前页面不是已批准的申请表，或表单在审批后发生了变化。请勿继续自动填写。", browserAssistSafetyStop: "页面包含登录、注册、验证码、多因素验证、跨域表单或其他禁止自动处理的步骤，请改为手动操作。", browserAssistUnsupportedControl: "表单包含当前无法安全自动填写的控件；JobFlow 没有修改页面。", browserAssistUploadMismatch: "已批准材料与当前上传控件无法一一对应；JobFlow 没有上传。", browserAssistFinalLocked: "最终提交在代码层锁定，只能由你亲自点击。", browserAssistLeaseInvalid: "本次 30 分钟授权已失效，请从该申请重新开始。",
  ...
  en: {
    ...
    pipelineBody: "See profile readiness, approval queues, and real assisted application status. JobFlow reads a company form, fills, and attaches materials only after your explicit approval for one application.", safetyGuardOn: "Submit and automatic retry always locked", offlineMode: "Local prep + user-present assist", assistedMode: "Local prep + user-present assist", authorizedActionsAudited: "Authorized actions audited", browserAssistTitle: "Assisted application on a real company site", browserAssistBody: "While you are present, JobFlow fills approved fields and attaches approved materials, then enforces a hard stop before final submission.", browserAssistIdle: "Choose an application", browserCompanionStep: "Install the browser companion once", browserCompanionHelp: "On first use, double-click “Install JobFlow Browser Companion.cmd” in the project root and follow the Edge or Chrome instructions. You do not reinstall it for each application.", browserCompanionNotPaired: "Not paired for this application", browserCompanionPaired: "Browser companion paired", browserAssistBoundaryTitle: "Non-negotiable boundary", browserAssistBoundary: "JobFlow never clicks Submit, Next, login, account registration, or CAPTCHA. Only you can click final Submit. An unclear result asks you and is never retried.", browserAssistCompanyOnly: "This fastest version supports approved guest, same-origin, single-page company forms only.", browserAssistConsent: "I authorize 30 minutes of real form inspection, prefill, and approved-material attachment for this application only; I will review everything and click final Submit myself.", startBrowserAssist: "Start assisted prefill", startBrowserAssistNow: "Connect browser", startingBrowserAssist: "Creating the one-time browser connection…", browserAssistConfirmFirst: "Check the authorization box for this real assisted session first.", browserAssistPairing: "Pairing the browser companion…", browserAssistPaired: "Paired. Open the approved application page, then use the JobFlow J icon in the browser toolbar.", browserAssistExtensionMissing: "No companion response arrived. Run the installer entry and load the extension in your browser first.", openApprovedApplication: "Open approved application page", browserAssistAwaitingSubmit: "Fields and materials are ready. Review them and click final Submit yourself.", browserAssistObserving: "Your submit click was detected; reading the result page.", browserAssistConfirmed: "Submission confirmed and result-page receipt recorded.", browserAssistUnknown: "The outcome cannot be verified: was it submitted successfully?", browserAssistFailed: "The page clearly reports failure. Nothing was retried; review and approve again before another attempt.", submittedYes: "Yes, submitted successfully", submittedNo: "No, it was not submitted", resolveUnknownConfirm: "Confirm your answer? JobFlow will not retry automatically.", resolvingSubmission: "Saving your submission result…", browserAssistResolved: "Submission result saved.", statusSubmitted: "Reading result", statusSubmissionUnknown: "Outcome needs confirmation", statusConfirmed: "Submission confirmed", installCompanion: "Install browser companion",
    browserAssistNotApproved: "This application has not been approved yet. Approve the current review packet first.", browserAssistRouteUnsupported: "This version handles same-origin, guest, single-page company forms only. ATS redirects and login flows require a later adapter.", browserAssistActive: "Another application is already in an assisted session. Finish it or use the emergency stop first.", browserAssistWrongPage: "This is not the approved application page, or its form changed after review. JobFlow did not continue.", browserAssistSafetyStop: "The page includes login, registration, CAPTCHA, MFA, a cross-origin form, or another forbidden step. Continue manually.", browserAssistUnsupportedControl: "The form contains a control that cannot yet be filled safely. JobFlow made no page changes.", browserAssistUploadMismatch: "The approved materials do not map one-to-one to the current upload controls. Nothing was uploaded.", browserAssistFinalLocked: "Final submission is locked in code and only you can click it.", browserAssistLeaseInvalid: "This 30-minute authorization expired. Start again from the application.",
...
const ACTIVITY_ESTIMATES = {
  ...
  preparingOfflineApplication: 150, startingBrowserAssist: 10, resolvingSubmission: 5
};
...
function renderBrowserAssist(recent){
  ...
  document.querySelector("#browserAssistApplication").textContent=item.application_id||"";
...
document.addEventListener("click", async event => {
  ...
  if(startBrowserAssist){
    ...
    try{
      ...
      renderBrowserAssist(state.data?.dashboard?.recent_applications||[]);
      window.postMessage({
        type:"JOBFLOW_PAIR_REQUEST",protocol_version:1,
        pairing:{protocol_version:1,base_url:location.origin,assist_path:result.assist_path}
      },location.origin);
...
window.addEventListener("message",event=>{
  if(event.source!==window||event.origin!==location.origin||event.data?.protocol_version!==1)return;
